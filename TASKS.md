...
## Current phase — Establish the project

**Goal:** Create a shared understanding of the project and its first verifiable outcome.
...
- [ ] The project purpose and boundaries are clear.
- [ ] The current state is accurate.
- [ ] The next task is unambiguous.
- [x] Important decisions, risks, and blockers are recorded.
...
- [>] `P1-001` Create the 30-minute run of show.
  - **Owner:** Francis Billy Raposas
  - **Acceptance:** Every segment has a duration, all durations total 30 minutes, and exactly five minutes are reserved for questions.
  - **Evidence:** Not yet verified
- [ ] `P1-002` Create the simple four-file explanation.
  - **Owner:** Francis Billy Raposas
  - **Acceptance:** `AGENTS.md`, `ABOUT.md`, `CONTEXT.md`, and `TASKS.md` are each explained in plain language, including how they work together without chat history.
  - **Evidence:** Not yet verified
- [ ] `P1-003` Design the live Media Magic demonstration.
  - **Owner:** Francis Billy Raposas
  - **Acceptance:** The scenario, starting state, actions, expected outcome, timing, required assets, and recovery plan are documented and rehearsable.
  - **Evidence:** Not yet verified
- [ ] `P1-004` Design the Claude handoff test.
  - **Owner:** Francis Billy Raposas
  - **Acceptance:** Claude receives only the four handoff files, accurately summarizes the project, and identifies the correct next task without access to earlier chat history.
  - **Evidence:** Not yet verified
- [ ] `P1-005` Prepare the downloadable Project Starter skill.
  - **Owner:** Francis Billy Raposas
  - **Acceptance:** The skill is packaged, downloadable from a stable attendee-accessible location, and installation or use instructions are included.
  - **Evidence:** Not yet verified
- [ ] `P1-006` Prepare presentation and facilitation materials.
  - **Owner:** Francis Billy Raposas
